...
<div class="awsm-job-form-inner">
    <div class="row" style="padding: 20px 60px;">
        <div class="col-7 form-content-div">
            <?php
/**
...
?>
            ...
            <form
                id="<?php echo $form_attrs['single_form'] ? 'awsm-application-form' : esc_attr('awsm-application-form-' . $form_attrs['job_id']); ?>"
                class="awsm-application-form" name="applicationform" method="post" enctype="multipart/form-data">
...
?>
        ...
        <div class="col-5">
            <div class="d-flex justify-content-center align-items-center" style="margin-top: 150px;">
                <img src="https://img.freepik.com/premium-vector/job-vacancy-job-placement_124715-2286.jpg" alt="">
            </div>
        </div>
    </div>
