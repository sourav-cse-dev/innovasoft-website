...
{
        wp_enqueue_style('chld_thm_cfg_parent', trailingslashit(get_template_directory_uri()) . 'style.css', array('vw-corporate-lite-block-style', 'vw-corporate-lite-block-patterns-style-frontend', 'bootstrap-style'));
    }
endif;
