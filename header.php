...
<body                                                                  <?php body_class(); ?>>
    ...
    <header role="banner">
        ...
        <div class="header">
            ...
            <?php }?>
            <div class="menu-sec innova-color-10 header py-3<?php if (get_theme_mod('vw_corporate_lite_sticky_header', false) == 1 || get_theme_mod('vw_corporate_lite_stickyheader_hide_show', false) == 1) {?> header-sticky"
